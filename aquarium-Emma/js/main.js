...
const schoolEvents = [
    ...
    { name: "教職員工健檢", start: "09/11", end: "09/11" },
    { name: "小學學校日(中學部入班)", start: "09/12", end: "09/12" },
    ...
    { name: "第一次段考+成績輸入", start: "10/13", end: "10/19", display: "10/13~10/19" },
    { name: "高三第一次英語聽力測驗", start: "10/17", end: "10/17" },
    { name: "高一新生成長營", start: "10/22", end: "10/23", display: "10/22~10/23" },
    { name: "光復節補假", start: "10/26", end: "10/26", type: "holiday" },
    { name: "第一次作業普查", start: "10/27", end: "10/30", display: "10/27~10/30" },
    { name: "英文歌唱比賽", start: "10/30", end: "10/30" },
    { name: "高中英文作文比賽", start: "10/31", end: "10/31" },
    { name: "國九、高三複習考週", start: "11/02", end: "11/06", display: "11/02~11/06" },
    { name: "國七新生成長營", start: "11/05", end: "11/06", display: "11/05~11/06" },
    { name: "北區高中英文單字比賽", start: "11/07", end: "11/07" },
    { name: "高三誓師祈福禮", start: "11/13", end: "11/13" },
    { name: "高中英文演說比賽", start: "11/15", end: "11/15" },
    { name: "第二次段考+成績輸入", start: "11/25", end: "11/30", display: "11/25~11/30" },
    { name: "聖誕節點燈", start: "12/04", end: "12/04" },
    { name: "第二次作業普查", start: "12/07", end: "12/11", display: "12/07~12/11" },
    ...
    { name: "聖小直生家長說明會", start: "01/09", end: "01/09" },
    { name: "ESL&本土語期末發表", start: "01/15", end: "01/15" },
    { name: "國中新生說明會", start: "01/16", end: "01/16" },
    { name: "115-1 期末考+成績輸入", start: "01/18", end: "01/22", display: "01/18~01/22" },
    { name: "115-1 休業式", start: "01/20", end: "01/20" },
    { name: "寒假開始", start: "01/21", end: "01/21", type: "holiday" },
    { name: "高三學測", start: "01/22", end: "01/24", display: "01/22~01/24" },
    { name: "寒假輔導", start: "01/21", end: "01/27", display: "01/21~01/27" },
    { name: "寒假數感營隊", start: "01/21", end: "01/27", display: "01/21~01/27" },
    { name: "國中補考", start: "01/28", end: "01/28" },
    { name: "國高補考", start: "01/29", end: "01/29" },
    { name: "春節", start: "02/04", end: "02/10", type: "holiday" },
    { name: "115-2 開學", start: "02/11", end: "02/11" }
];
